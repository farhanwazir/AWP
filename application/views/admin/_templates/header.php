...
<head>
    ...
    echo base_url($frameworks_dir . '/bootstrap/css/bootstrap.min.css'); ?>">
    <link rel="stylesheet" href="<?php /* */
    echo base_url($frameworks_dir . '/font-awesome/css/font-awesome.min.css'); ?>">
    <link rel="stylesheet" href="<?php /* */
    echo base_url($frameworks_dir . '/ionicons/css/ionicons.min.css'); ?>">
    <link rel="stylesheet" href="<?php /* */
    echo base_url($frameworks_dir . '/adminlte/css/adminlte.min.css'); ?>">
    <link rel="stylesheet" href="<?php /* */
    echo base_url($frameworks_dir . '/adminlte/css/skins/skin-blue.min.css'); ?>"> <?php /* */
    if ($mobile === FALSE && !isset($admin_prefs['transition_page'])): ?>
        <link rel="stylesheet" href="<?php /* */
        echo base_url($plugins_dir . '/animsition/animsition.min.css'); ?>">    <?php /* */
    endif; ?>    <?php /* */
    if ($this->router->fetch_class() == 'groups' && ($this->router->fetch_method() == 'create' OR $this->router->fetch_method() == 'edit')): ?>
        <link rel="stylesheet" href="<?php /* */
    ...
    <link rel="stylesheet" href="<?php /* */
    echo base_url($plugins_dir . '/PNotify/pnotify.custom.min.css'); ?>"> <?php /* */
    if ($mobile === FALSE): ?>        <!--[if lt IE 9]>
                                      <script
                                          src="<?php /* */ echo base_url($plugins_dir . '/html5shiv/html5shiv.min.js'); ?>"></script>
                                      <script
                                          src="<?php /* */ echo base_url($plugins_dir . '/respond/respond.min.js'); ?>"></script>        <![endif]-->    <?php /* */
    endif; ?>
    <script src="<?php /* */
