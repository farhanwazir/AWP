                        ...
                        <div class="row">
                            <div class="col-md-12">                                <!-- Content table -->
                                <table id="report-table" class="table table-bordered table-responsive bs-tbl"
                                       ...
                                       data-show-columns="true" data-show-export="true" data-mobile-responsive="true"
                                       data-query-params="set_params" data-sort-order="desc">
                                    <thead>
                                    <th data-field="transaction_id" data-switchable="true"
                                        data-visible="true"><?= lang('common_report_col_transaction_id'); ?></th>
                                    <th data-field="star_id"
                                        data-switchable="false"><?= lang('common_report_col_star'); ?></th>
                                    <th data-field="product_type"><?= lang('airtime_col_transaction_type'); ?></th>
                                    <th data-field="sale_amount"><?= lang('common_report_col_sale_amount'); ?></th>
                                    <!--<th data-field="profit_fraction"><? /*=lang('common_report_col_profit_fraction');*/ ?></th>                                    <th data-field="profit"><? /*=lang('common_report_col_profit');*/ ?></th>-->
