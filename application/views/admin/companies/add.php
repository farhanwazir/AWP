                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="company_id">
                                                    <?= lang('company_company_code'); ?>
                                                    <?= lang('common_required'); ?>
                                                </label>
                                                <input type="text" class="form-control"
                                                       required name="company_id"
                                                       value="<?= isset($_POST['company_id']) ?
                                                           $_POST['company_id'] : ''; ?>">
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <input type="radio" class="form-control iCheckOff"
                                                           ...
                                                           data-size="normal"
                                                        <?= (isset($_POST['customer_type']) && $_POST['customer_type'] == lang('company_customer_type_wholesale_code')) ? 'checked' : ''; ?>>
                                                    &nbsp; <input type="radio" class="form-control iCheckOff"
                                                                  name="customer_type"
